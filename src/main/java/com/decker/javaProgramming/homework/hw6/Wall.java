...
public class Wall implements Supplier<Wall> {
    ...
    public static void accept(Wall r, Brick brick) {
        r.lay(brick);
    }

    public static void combine(Wall r1, Wall r2) {
        Wall.linkTwoWalls(r1,r2);
    }
